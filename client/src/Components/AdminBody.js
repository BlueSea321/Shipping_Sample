  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <AppBar
        position="fixed"
        open={open}
        sx={{ backgroundColor: "#f47920", height: "80px" }}
      >
        <Toolbar sx={{ margin: "auto 0px" }}>
          ...
          <Box sx={{ cursor: "pointer" }}>
            {isLogin ? (
              <Typography onClick={() => navigate("/logout")}>
                Logout
              </Typography>
            ) : (
        ...
        <List>
          <ListItem disablePadding sx={{ display: "block" }} onClick={() => navigate('/admin/home')}>
            ...
            >
              ...
              <ListItemText primary="Couriers" sx={{ opacity: open ? 1 : 0 }} />
            </ListItemButton>
          </ListItem>
          <ListItem disablePadding sx={{ display: "block" }} onClick={() => navigate('/admin/offers')}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? "initial" : "center",
